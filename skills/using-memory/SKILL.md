...
In Claude Code sessions, hooks auto-recall relevant memories on every prompt
(injected as "Relevant long-term memory") and auto-capture a Request/Outcome
record when a turn ends. Do not re-search what the injection already covers;
do not capture a summary of the turn you just finished.
